...
function init() {
    ...
    for (var name in players) {
        $("#players").append('<li id="' + name + '" onClick="addPlayer(\'' + name + '\')" data-icon="arrow-r" class="ui-first-child ui-last-child"><a href="#" class="ui-btn ui-btn-icon-right ui-icon-arrow-r"><img height="44" width="30" src="img/' + players[name] + '"> ' + name + '</a></li>');
    }

    for (var key in positions) {
        $("#positions").append('<li id="'+key+'" onClick="setPosition(\''+key+'\')" class="ui-btn">'+key+ ' - '+positions[key]+'</a></li>');
    }
...
function setPosition(position){
    if(position != 'BENCH'){
        ...
        $("#playeronbench").append('<li id="b_'+currentPlayer.name+'" onClick="doSwitchPlayer(\''+currentPlayer.name+'\')" data-icon="arrow-r" class="ui-first-child ui-last-child"><a href="#" class="ui-btn ui-btn-icon-right ui-icon-arrow-r"><img height="44" width="30" src="img/'+currentPlayer.img+'"> '+currentPlayer.name+ ' '  + currentPlayer.viewPositions() + '</a></li>');
...
function updateActiveView(){
    $('#players li').remove();
    for (var name in activePlayers) {
        $("#players").append('<li id="'+activePlayers[name].name+'" onClick="changePlayer(\''+activePlayers[name].name+'\')" data-icon="arrow-r" class="ui-first-child ui-last-child"><a href="#" class="ui-btn ui-btn-icon-right ui-icon-arrow-r"><img height="44" width="30" src="img/'+players[name]+'"> '+activePlayers[name].toString()+ '</a></li>');
    }
    if(startTime != null){
